...
rd _temp
echo:
if %FAILED_ARK_BUILD% neq 1 (echo:Successfully built Beatles Rock Band Deluxe ARK.)
...
if %FAILED_ARK_BUILD% neq 1 (echo:Launching Xenia &"%~dp0\_xenia\xenia_canary" "%~dp0\_build\xbox\default_xenia.xex")
echo:
